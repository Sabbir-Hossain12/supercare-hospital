            ...
            <div class="modal-body">
                <form id="createForm" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label for="appointment_url" class="form-label">Appointment Url</label>
                                <input type="text" id="appointment_url" name="appointment_url" class="form-control" placeholder="Appointment Url">
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateForm" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            <label for="up_appointment_url" class="form-label">Appointment Url</label>
                            <input type="text" id="up_appointment_url" name="appointment_url" class="form-control" placeholder="Appointment Url">
                        </div>
