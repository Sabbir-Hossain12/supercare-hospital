...
@section('body-content')
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-fun">
                        ...
                        <div class="content">
                            <span class="counter">@if( !empty($basicInfo->room_number) )
                                    {{ $basicInfo->room_number }}
                                @else
                                    3468
                                @endif</span>
                            <p>@if( !empty($basicInfo->room_icons) )
                                    {{ $basicInfo->room_title }}
                                @else
                                    Hospital Rooms
                                @endif</p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-fun">
                        ...
                        <div class="content">
                            <span class="counter">@if( !empty($basicInfo->doctor_number) )
                                    {{ $basicInfo->doctor_number }}
                                @else
                                    557
                                @endif</span>
                            <p>@if( !empty($basicInfo->doctor_title) )
                                    {{ $basicInfo->doctor_title }}
                                @else
                                    Specialist Doctors
                                @endif </p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-fun">
                        ...
                        <div class="content">
                            <span class="counter">@if( !empty($basicInfo->patient_number) )
                                    {{ $basicInfo->patient_number }}
                                @else
                                    4379
                                @endif</span>
                            <p>@if( !empty($basicInfo->patient_title) )
                                    {{ $basicInfo->patient_title }}
                                @else
                                    Happy Patients
                                @endif </p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-fun">
                        ...
                        <div class="content">
                            <span class="counter">@if( !empty($basicInfo->experience_number) )
                                    {{ $basicInfo->experience_number }}
                                @else
                                    32
                                @endif</span>
                            <p>@if( !empty($basicInfo->experience_title) )
                                    {{ $basicInfo->experience_title }}
                                @else
                                    Years of Experience
                                @endif</p>
                        </div>
                    ...
                    <div class="choose-right" style="background-image: url('{{ asset($about->image) }}');">
                        <div class="video-image">
                            ...
                            <button type="button" data-toggle="modal"
                                    data-src="{{ ($about->video) }}" data-target="#myModal"
                                    class="video video-popup mfp-iframe video-btn"><i class="fa fa-play"></i></button>
    ...
    <section class="call-action overlay" data-stellar-background-ratio="0.5"
             style="	background-image:url({{ asset('public/frontend/img/call-bg.jpg') }});">
        <div class="container">
            <div class="row">
